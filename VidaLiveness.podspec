...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://tabrezpasha1@bitbucket.org/vidaid/vidaliveness.git', :tag => s.version.to_s } 
#{ :http => 'https://f005.backblazeb2.com/file/LivenessFramework/VidaLiveness.framework.zip'}
